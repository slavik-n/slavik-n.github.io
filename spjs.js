...
$('#xmodal_form').html('<p style="margin-left: 2px; padding: 3px; padding-bottom: 0px;">ааЕаЙббаВаИаЕ б <strong>' + username + '</strong></p><div><input type="button" value="ааАаН аПаО аИаМаЕаНаИ" onclick="doitfor(\'' + username + '\', \'banOnName\');"><input type="button" value="ааАаН аПаО IP" onclick="doitfor(\'' + username + '\', \'banOnIP\');"><br><input type="button" value="/kick" onclick="doitfor(\'' + username + '\', \'kick\')">&nbsp;<input type="button" value="/mute" onclick="doitfor(\'' + username + '\', \'mute\');">&nbsp;<input type="button" value="/smute" onclick="doitfor(\'' + username + '\', \'smute\');"><br><input type="button" value="аЃаДаАаЛаИбб аВбаЕ аЕаГаО аВаИаДаЕаО" onclick="doitfor(\'' + username + '\', \'cleanVideos\');"><input type="button" value="/unmute" onclick="doitfor(\'' + username + '\', \'unmute\');">&nbsp;<input type="button" value="а аАаЗаБаАаНаИбб аНаИаК" onclick="doitfor(\'' + username + '\', \'unban\');"><input type="button" value="ааАбб/баНббб аЗаВаЕаЗаДб" onclick="doitfor(\'' + username + '\', \'giveLeader\');"></div>');
}
    }
}
...
$('#leftpane').prepend('<div id="chatcommands" class="col-lg-12 col-md-12" style="display: none;"><div class="well poll-menu"><button class="btn btn-sm btn-danger pull-right" onclick="ShowHideID(\'chatcommands\');">ааАаКбббб</button><h3>аЁаПаИбаОаК аКаОаМаАаНаД</h3><h6>ааАаЗаОаВбаЕ:</h6><p><code>/me</code> т аНаАаПаИбаАбб аО баЕаБаЕ аВ ббаЕббаЕаМ аЛаИбаЕ.<br><code>/afk</code> т аПаЕбаЕбаОаД аВ баЕаЖаИаМ аОббббббаВаИб (AFK) аИаЛаИ аВббаОаД аИаЗ аНаЕаГаО.<br><code>/sp</code> т аПаОаМаЕбаАаЕб аВаАбаЕ баОаОаБбаЕаНаИаЕ аПаОаД баПаОаЙаЛаЕб.<h6>ааОаПаОаЛаНаИбаЕаЛбаНбаЕ</h6><code>!skip</code> т абаОаГаОаЛаОбаОаВаАбб аЗаА аПбаОаПббаК баЕаКббаЕаГаО аВаИаДаЕаО.<br><code>!time</code> т ааОаКаАаЗаАбб аЛаОаКаАаЛбаНаОаЕ аВбаЕаМб.<br><code>!inba</code> т PARTY TIIIME.</p><h6>аЇаАб-аБаОб:</h6><p><code>!q</code> т аПаОаКаАаЗаАбб баЛббаАаЙаНбб баИбаАбб.<br><code>!qchat</code> т аПаОаКаАаЗаАбб баЛббаАаЙаНбб баИбаАбб ббаАббаНаИаКаОаВ баАбаА. ааОаЖаНаО аИбаПаОаЛбаЗаОаВаАбб баОаВаМаЕббаНаО б аЛаОаГаИаНаОаМ ббаАббаНаИаКаА баАбаА, аНаАаПбаИаМаЕб, <code>!qchat username</code>.<br><code>!ask</code> т баПбаОбаИбб аО баЕаМ-баО баОаБаОбаА.<br><code>!pick arg1,arg2</code> т аВбаБаИбаАаЕб аМаЕаЖаДб аНаЕбаКаОаЛбаКаИаМаИ баЛаЕаМаЕаНбаАаМаИ баЕаКббаА, аКаОбаОббаЕ баАаЗаДаЕаЛаЕаНб аЗаАаПббаОаЙ.<br><code>!dice</code> т аКаИаНббб аКбаБаИаК (баИбаЛаО аОб 1 аДаО 6).<br><code>!roll</code> т аКбббаИаЛаКаА (баИбаЛаА аОб 1 аДаО 999).<br><code>!translate [en>ru] Text</code> т аПаЕбаЕаВаОаДаИб баЕаКбб баОаОаБбаЕаНаИб б баЗбаКаА A аНаА баЗбаК B.</p><h6>аЄаОбаМаАбаИбаОаВаАаНаИаЕ баЕаКббаА:</h6><p><code>__text__</code> т <em>аКбббаИаВ</em>.<br><code>*text*</code> т <b>аЖаИбаНбаЙ ббаИбб</b>.<br><code>`text`</code> т аКаОаД, аМаОаНаОбаИбаИаНаНбаЙ баЕаКбб.<br><code>~~text~~</code> т <strike>аЗаАбаЕбаКаНбббаЙ баЕаКбб</strike>.</p></div></div>');
